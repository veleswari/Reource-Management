            ...
            if (userEmail != null && authentication == null) {
                ...
                if (jwtService.isTokenValid(jwt, userDetails)) {
                    ...
                    if (refreshedToken != null) {
                        // Store refreshed token or handle as necessary
                        // Example: Send refreshed token back to client
                        response.setHeader("Authorization", "Bearer " + refreshedToken);
                    } else {
                        // Handle unable to refresh token scenario
                        // Example: Send unauthorized response or redirect to login
